...
const Reviews: React.FC<{ reviews: IReview[] | undefined; idPost: string }> = ({
  ...
  useEffect(() => {
    if (typeof window !== undefined && window.localStorage) {
      ...
      setToken(JSON.parse(userSession!));
    }
  }, []);
  ...
  const handleSubmitReview = async (
    ...
    if (rating && commentDta) {
      try {
        ...
        await setResponseDta(resData);

        if (res.ok) {
          Swal.fire({
            title: "¡Gracias por dejar tu reseña!",
            text: "Has subido tu reseña con exito",
            icon: "success",
          });
        }
      } catch (error: any) {
              ...
              return (
                ...
                >
                  <div className="flex items-center mb-4">
                    ...
                    <div className=" dark:text-white">
                      ...
                      <p className="text-base text-gray-400">
                        Se unio el {review.user.createdAt}
                      </p>
                    </div>
                  </div>
                  ...
                  <footer className="mb-5 text-sm text-gray-400">
                    <p>Publico la reseña el {review.created_at}</p>
                  </footer>
