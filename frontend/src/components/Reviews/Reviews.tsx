...
const Reviews: React.FC<{ reviews: IReview[] | undefined; idPost: string }> = ({
  ...
  const [commentDta, setCommentDta] = useState<string | undefined>();
  ...
  const handleSubmitReview = async (
    ...
    if (rating && commentDta) {
      ...
      Swal.fire({
        ...
        text: "Debes llenar tanto el rating como el comentario",
        icon: "warning",
      });
    }
  };
        ...
        {token ? (
          <div className="flex flex-col w-full md:w-[40%] gap-5">
            <div className="w-full flex flex-row gap-2 items-center">
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-5 h-5 md:w-6 md:h-6 fill-[#c2e94e]"
              >
              ...
              <h1 className="text-base md:text-xl font-semibold text-gray-300">
                Deja tu reseña
              </h1>
            </div>
            <form className="flex flex-col gap-7" onSubmit={handleSubmitReview}>
              <div className="flex flex-col">
                <h1 className="text-[#c2e94e] text-sm md:text-base">
                  ¿Cuanta calificacion le das?
                </h1>
              ...
              <div className="flex flex-col gap-3">
                <textarea
                  id="message"
                  className=" resize-y w-full h-[90px]  md:w-[70%] text-sm text-gray-100 bg-transparent  outline-none  placeholder-gray-300 border-b-[1px] focus:border-b-[1px] focus:border-b-[#C4FF0D]"
                ...
                {loadingButton ? (
                  <button
                    type="submit"
                    className="w-full flex flex-row gap-2 items-center justify-center md:w-[90px] h-[40px] text-sm font-medium text-gray-300 hover:text-[#222222] hover:font-medium bg-[#222222] cursor-pointer rounded-3xl border-2 border-[#c2e94e] shadow-[inset_0px_-2px_0px_1px_#c2e94e] group hover:bg-[#c2e94e] transition duration-300 ease-in-out"
                  >
                    <div role="status">
                      <svg
                        aria-hidden="true"
                        className="inline w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-[#c2e94e]"
                        viewBox="0 0 100 101"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                      >
                  ...
                  <button
                    type="submit"
                    className="w-full md:w-[90px] h-[40px] text-sm font-medium text-gray-300 hover:text-[#222222] hover:font-medium bg-[#222222] cursor-pointer rounded-3xl border-2 border-[#c2e94e] shadow-[inset_0px_-2px_0px_1px_#c2e94e] group hover:bg-[#c2e94e] transition duration-300 ease-in-out"
                  >
                    Enviar
                  </button>
                )}
          ...
          <div className="flex flex-col items-center h-[250px] gap-4 px-5 py-5 border-b-2 border-t-2">
            <h1 className="text-xl text-gray-200">
              ...
              <Link
                href="/login"
                className="hover:text-[#C4FF0D] hover:underline duration-300"
              >
                Inicia sesion
              </Link>
              /
            ...
            <svg
              className="w-[130px] h-[130px] text-yellow-300"
              aria-hidden="true"
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              viewBox="0 0 22 20"
        ...
        <div className="flex flex-col gap-9 w-full md:w-[50%]">
          {reviews?.length! > 0 ? (
            reviews?.map((review) => {
              ...
              const dateUser = new Date(dateUserStr);
              const joinUsDate = format(dateUser, "MM/dd/yyyy");
              ...
              return (
                <article
                  key={review.id}
                  className="bg-[#222222] px-8 py-8 rounded-2xl "
                >
            ...
            <div className="flex flex-col w-full gap-6">
              <h1 className="text-base md:text-xl text-gray-200">
                ¡Esta publicacion no tiene reseñas todavia!
              </h1>
              <div className="flex flex-row bg-[#222222] py-4 px-4 gap-2 justify-center rounded-2xl w-[150px] items-center ">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
