...
export default function Home() {
  return (
    ...
    <section className="w-full h-full flex justify-center">
      <div className="w-full bg-no-repeat bg-cover md:shadow-xl bg-home flex justify-center items-center min-h-[600px] bg-top">
    ...
    <section id="vehiculos" className="w-full md:mt-4 flex flex-col justify-around">
