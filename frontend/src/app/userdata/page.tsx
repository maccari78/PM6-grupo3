...
const UserProfile: React.FC = () => {
    return (
        <>
        <Sidebar/>
      <div className="max-w-6xl mx-auto rounded-xl mt-20">
      ...
      />
        ...
        <div className="text-center mt-2">
          <h2 className="text-lg font-medium text-gray-900">Luis Perez</h2>
        ...
        <div className="px-6 py-4">
        <h3 className="text-lg font-medium text-gray-900">Sale Posts</h3>
